 ...
 * <li>Well-formedness of label expressions (only using atomic proposition indices that are defined).
 * <li>Well-formedness of acceptance (only using acceptance set indices that are defined).
 * </ul>
 */
...
public:
  ...
  virtual void notifyBodyStart() override {
    ...
    // check that all AP indices in aliases are valid
    if (!numberOfAPs) {
